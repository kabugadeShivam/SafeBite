...
class GovernmentOfficer(Base):
    ...
    investigations = relationship("Investigation", back_populates="officer", foreign_keys="Investigation.officer_id")
...
class Investigation(Base):
    ...
    verified_by = Column(Integer, ForeignKey("government_officers.id"), nullable=True)

    alert = relationship("Alert", back_populates="investigation")
    officer = relationship("GovernmentOfficer", back_populates="investigations", foreign_keys=[officer_id])
