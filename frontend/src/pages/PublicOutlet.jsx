...
function decisionLabel(decision) {
  switch (String(decision || "").toUpperCase()) {
    ...
    case "DISMISSED":
      return "DISMISSED";
    default:
      return String(decision || "NOT AVAILABLE")
        .replaceAll("_", " ");
  }
}
...
export default function PublicOutlet() {
  ...
  const monthlyAssessmentAvailable = Boolean(
    officialStatus.audit_month
  );
      ...
      <main className="public-container">
        ...
        <section className="public-card public-hero">
          <div className="public-eyebrow">
            MONTHLY FOOD-SAFETY PERFORMANCE
          </div>

          <h1>
            {outlet.name || "Registered Food Outlet"}
          </h1>
          ...
          <div className={statusClass(status)}>
            ...
            <div>
              ...
              <small>
                {monthlyAssessmentAvailable
                  ? `AI monthly assessment • ${officialStatus.audit_month}`
          ...
          <div className="public-government-note">
            This information is published by the SafeBite government
            platform. The public score is generated from official
            SafeBite audit data and AI-assisted monthly analysis.
            Government officers remain responsible for official decisions.
          </div>
        </section>
        ...
        {hasVerifiedOutcome && (
          <section className="public-card">
            ...
            >
              {verifiedOutcome.decision && (
                <div>
                  <span>Decision</span>
                  <strong>
                    {decisionLabel(verifiedOutcome.decision)}
                  </strong>
                </div>
              )}
              ...
              {verifiedOutcome.status && (
                <div>
                  ...
                  <strong>
                    {String(verifiedOutcome.status).replaceAll("_", " ")}
                  </strong>
                </div>
              )}
              ...
              {verifiedOutcome.verified_at && (
                <div>
                  ...
                  <strong>
                    {formatDate(verifiedOutcome.verified_at)}
                  </strong>
                </div>
              )}
            </div>
            ...
            >
              This outcome reflects an authorised government investigation
              and is separate from preliminary AI screening.
            </p>
          </section>
        )}
          ...
          <div className="public-card">
            ...
            <div className="public-list">
              ...
              <div>
                ...
                <strong>
                  {officialStatus.audit_month || "Not available"}
                </strong>
              </div>
              ...
              <div>
                ...
                <strong>
                  {outlet.registration_id || registrationId}
                </strong>
              </div>
          ...
          <div className="public-card">
            ...
            {strengths.length === 0 && concerns.length === 0 && (
              <p className="public-muted">
                No additional public observations are available.
              </p>
            )}
          </div>
        </section>
        ...
        <section className="public-card public-verification">
          <div>
            ...
            <strong>
              {data.source || "SafeBite Government Platform"}
            </strong>
          </div>
        ...
        <section className="public-card">
          ...
          <p className="public-government-note">
            Customers can submit a photo or video describing a food-safety
            concern. SafeBite may use AI to screen the evidence before a
